...
const About = () => {
	return (
		...
		<div className="text-center mb-8"> 
                ...
                <div className="text-center mb-8"> 
                    <h1 className="text-2xl mt-6 font-general-bold sm:text-3xl md:text-4xl">Professional Certifications</h1>
                    <p className="mt-4 text-base text-gray-500 font-general-light md:text-lg lg:text-xl xl:text-2xl">I hold the following professional certifications, demonstrating my commitment to enhancing my skills and knowledge in Scrum and IT service management:</p>
                </div>

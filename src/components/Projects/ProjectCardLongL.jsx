...
function ProjectCardLongL(props) {
  ...
  >
    <div className="col-span-2 row-span-3 col-span-3 ml-6">
...
<article className="w-full md:w-2/3 relative overflow-hidden rounded-lg shadow transition hover:shadow-lg">
  ...
  >
    <div className="p-4 ml-20 sm:p-6">
      ...
      <p className="mt-2 md:w-2/3 line-clamp-3 text-sm/relaxed text-white/95">
        {props.description}
      </p>
    </div>
  </div>
...
export default ProjectCardLongL;
...
const CarouselCard = () => {
    const card1 = projectsCarousel.find((project) => project.id === 1);
    const card2 = projectsCarousel.find((project) => project.id === 2);
    const card3 = projectsCarousel.find((project) => project.id === 3);
    ...
    return (
      <div id="keen-slider" className="keen-slider flex overflow-hidden relative select-none touch-callout-none tap-highlight-transparent min-h-full w-full">
        ...
        <div className="keen-slider__slide relative overflow-hidden w-full min-h-full">
          <blockquote className="flex flex-col justify-between bg-white shadow-sm ">

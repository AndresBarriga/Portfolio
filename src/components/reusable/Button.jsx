				...
				<div className="mt-12 space-y-12">
					<div className="flex">
						...
						<div className="ml-4">
							...
							<p className="mt-2 dark:text-gray-400">Ex usu illum iudico molestie. Pro ne agam facete mediocritatem.</p>
						</div>
					</div>
					<div className="flex">
						<div className="flex-shrink-0">
						...
						<div className="ml-4">
							...
							<p className="mt-2 dark:text-gray-400">Amet utinam aliquando ut mea, malis admodum ocurreret nec.</p>
						</div>
					</div>
					<div className="flex">
						<div className="flex-shrink-0">

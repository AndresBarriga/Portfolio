...
import productDev2 from "../../images/ProductDev2.png";
        ...
        >
            <div className="w-full  md:w-1/3 text-left ">
                ...
                <motion.p
                    ...
                    className="font-general-medium mt-4 text-base md:text-xl lg:text-2xl xl:text-3xl text-center sm:text-left leading-normal text-gray-500"
                >

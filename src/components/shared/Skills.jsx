...
function Skills(props) {
    return (
        <div className='flex flex-grow sm:w-1/2  md:w-1/2' >
          
            <a className="block rounded-xl border border-indigo-200 p-4 shadow-sm w-full md:w-auto lg:w-60  mx-6 my-1 " style={{ wordWrap: 'break-word', whiteSpace: 'normal' }}>

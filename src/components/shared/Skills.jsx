    ...
    return (
        <div >
          <div className="flex flex-wrap gap-4 sm:grid-cols-3 p-0 m-4 " >
            <a className="w-60  h-60  block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring mx-6 my-1" style={{ wordWrap: 'break-word', whiteSpace: 'normal' }}>
